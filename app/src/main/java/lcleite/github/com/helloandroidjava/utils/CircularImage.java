...
public class CircularImage {
    ...
    public static Bitmap getRoundedCornerBitmap(Bitmap bitmap, int newWidth, int newHeight) {
        Bitmap cropped = scaleCenterCrop(bitmap, newWidth, newHeight);
